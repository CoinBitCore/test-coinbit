...
class WalletTest(CoinbitTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 CTB from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 CTB in block rewards plus fees, but
        ...
        # Send 10 CTB with subtract fee from amount
        ...
        # Sendmany 10 CTB with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/CoinBitCore/coinbit/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
