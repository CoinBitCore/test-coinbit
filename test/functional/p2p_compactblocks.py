...
# TestNode: A peer we use to send messages to coinbitd, and store responses.
...
class CompactBlocksTest(CoinbitTestFramework):
    ...
    # This test actually causes coinbitd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that coinbitd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for coinbitd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # coinbitd will not send blocktxn responses for blocks whose height is
