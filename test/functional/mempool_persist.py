...
By default, coinbitd will dump mempool on shutdown and
...
class MempoolPersistTest(CoinbitTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give coinbitd a second to reload the mempool
        ...
        self.log.debug("Prevent coinbitd from writing mempool.dat to disk. Verify that `savemempool` fails")
