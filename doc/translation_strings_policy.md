...
This document provides guidelines for internationalization of the Coinbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `coinbit_en.ts` remains unchanged.
