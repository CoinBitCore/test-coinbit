...
* coinbit.conf: contains configuration settings for coinbitd or coinbit-qt
* coinbitd.pid: stores the process id of coinbitd while running
...
* debug.log: contains debug information and general logging generated by coinbitd or coinbit-qt
