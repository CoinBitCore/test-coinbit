Coinbit Core version 0.13.2 is now available from:

  <https://coinbit.org/bin/coinbit-core-0.13.2/>
...
- #8908 `4a974b2` Update coinbit-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow coinbit-tx to create v2 transactions (CTBdrak)
