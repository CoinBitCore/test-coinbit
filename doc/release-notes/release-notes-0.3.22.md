Download URL: https://sourceforge.net/projects/coinbit/files/Coinbit/coinbit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 CTB fee schedule (users still pay 0.01 CTB per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #coinbit00 - #coinbit99
