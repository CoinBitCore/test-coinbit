Coinbit Core version 0.9.2.1 is now available from:

  https://coinbit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CTB to 0.01 CTB
...
- Fix "Start coinbit on system login"
