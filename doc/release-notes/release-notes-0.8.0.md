Coinbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/coinbit/files/Coinbit/coinbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Coinbit
...
New/changed settings (command-line or coinbit.conf file)
--------------------------------------------------------
