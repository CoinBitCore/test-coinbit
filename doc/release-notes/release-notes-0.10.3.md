Coinbit Core version 0.10.3 is now available from:

  <https://coinbit.org/bin/coinbit-core-0.10.3/>
...
(see https://github.com/CoinBitCore/coinbit/pull/6793, as well as the 0.11.0
