Coinbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/coinbit/files/Coinbit/coinbit-0.5.4/
...
http://gitorious.org/coinbit/coinbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Coinbit-Qt notifications under Growl 1.3.
Increase required age of Coinbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCoinbit properly when installing Coinbit-Qt over it. (Windows)
