Coinbit Core version 0.9.4 is now available from:

  https://coinbit.org/bin/0.9.4/
...
this update is incompatible with the Coinbit system and could lead to consensus
forks.

Coinbit Core released binaries from https://coinbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~coinbit/+archive/ubuntu/coinbit
- A third-party or self-compiled Coinbit Core

upgrade to Coinbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
