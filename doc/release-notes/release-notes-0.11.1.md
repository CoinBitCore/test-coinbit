Coinbit Core version 0.11.1 is now available from:

  <https://coinbit.org/bin/coinbit-core-0.11.1/>
...
(see https://github.com/CoinBitCore/coinbit/pull/6795).
...
one was randomly violated by all deployed coinbit software prior to
...
Coinbit Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Coinbitj has done so for a similar span of time.
Coinbitjs and electrum have been more recently updated.
...
[1] On the Malleability of Coinbit Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/coinbit/paper_9.pdf
...
(see https://github.com/CoinBitCore/coinbit/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libcoinbitconsensus: avoid a crash in multi-threaded environments
