Coinbit Core version 0.10.4 is now available from:

  <https://coinbit.org/bin/coinbit-core-0.10.4/>
...
- #6953 `43c2789` Split coinbit-tx into its own package
- #6953 `dfe0d4d` Include coinbit-tx binary on Debian/Ubuntu
