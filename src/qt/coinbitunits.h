...
#ifndef COINBIT_QT_COINBITUNITS_H
#define COINBIT_QT_COINBITUNITS_H
...
/** Coinbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CoinbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CoinbitUnits(QObject *parent);

    /** Coinbit units.
      @note Source: https://en.coinbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CTB,
...
typedef CoinbitUnits::Unit CoinbitUnit;

#endif // COINBIT_QT_COINBITUNITS_H
