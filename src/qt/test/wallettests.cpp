...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CoinbitAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_coinbit-qt -platform xcb      # Linux
//     src/qt/test/test_coinbit-qt -platform windows  # Windows
//     src/qt/test/test_coinbit-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CoinbitUnits::formatWithUnit(unit, balance, false, CoinbitUnits::separatorAlways);
    ...
    // Amount input
    CoinbitAmountField* amountInput = receiveCoinsDialog.findChild<CoinbitAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: coinbit:")) != -1);
