...
#ifndef COINBIT_TEST_SCRIPTNUM10_H
#define COINBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Coinbit Core 0.10.0, for cross-comparison.
 */
public:
